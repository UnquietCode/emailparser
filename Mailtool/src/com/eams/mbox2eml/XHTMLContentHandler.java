...
public class XHTMLContentHandler extends SafeContentHandler {
	 ...
	 */
	private static final Set<String> HEAD = unmodifiableSet("title", "link",
			"base", "meta");
	 ...
	 */
	private static final Set<String> AUTO = unmodifiableSet("html", "head",
			"body", "frameset");

	/**
	 * The elements that get prepended with the {@link #TAB} character.
	 */
	private static final Set<String> INDENT = unmodifiableSet("li", "dd", "dt",
			"td", "th", "frame");

	/**
	 * The elements that get appended with the {@link #NL} character.
	 */
	public static final Set<String> ENDLINE = unmodifiableSet("p", "h1", "h2",
			"h3", "h4", "h5", "h6", "div", "ul", "ol", "dl", "pre", "hr",
			"blockquote", "address", "fieldset", "table", "form", "noscript",
			"li", "dt", "dd", "noframes", "br", "tr", "select", "option");
	...
	/**
	 * Starts an XHTML document by setting up the namespace mappings. The
	 * standard XHTML prefix is generated lazily when the first element is
	 * started.
	 */
	@Override
