 ...
 * @Time: 6:06:26 PM Aug 29, 2011
 * @Version: 
 */
package exception;

/**
 * @Description: This exception is thrown when parse errors are encountered. You
 *               can explicitly create objects of this exception type by calling
 *               the method generateParseException in the generated parser.
 * 
...
public class ParseException extends Exception {
	...
	public String getMessage() {
		...
		retval += "\" at line " + currentToken.next.beginLine + ", column "
				+ currentToken.next.beginColumn + " " + currentToken.image;
		retval += "." + eol;
